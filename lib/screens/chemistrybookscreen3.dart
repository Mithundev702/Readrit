...
class ChemistryBookScreen3 extends StatefulWidget {
  @override
  _ChemistryBookScreen3State createState() => _ChemistryBookScreen3State();
}

class _ChemistryBookScreen3State extends State<ChemistryBookScreen3> {
  int _rating = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("ENGINEERING CHEMISTRY - 3"),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              const Text(
                "Advanced concepts in physical chemistry including spectroscopy and quantum chemistry.",
