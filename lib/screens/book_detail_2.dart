  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("ENGINEERING DRAWING-1"),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              const Text(
                "This book covers the fundamentals of engineering drawing required for first-year engineering students. It explains key concepts in orthographic projections, sectioning, dimensioning, and layout drawings in a clear and easy-to-understand manner with practice exercises.",
              ...
              Center(
                child: ElevatedButton.icon(
                  ...
                  onPressed: () {
                    // Navigate to PDF viewer screen for Book 2
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => BookPDFViewer(
                          assetPath: 'assets/egbook.pdf.pdf', // Path for Book 2 PDF
                        ),
                      ),
                    );
                  },
