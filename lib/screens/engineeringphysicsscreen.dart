...
class EngineeringPhysicsBooksScreen extends StatefulWidget {
  @override
  _EngineeringPhysicsBooksScreenState createState() => _EngineeringPhysicsBooksScreenState();
}

class _EngineeringPhysicsBooksScreenState extends State<EngineeringPhysicsBooksScreen> with TickerProviderStateMixin {
  final List<Map<String, dynamic>> books = [
    {
      'title': 'MODERN ENGINEERING PHYSICS',
      'author': 'S. CHAND',
      'image': 'assets/physicsbook1.jpeg',
      'route': '/physicsbook1',
      'comments': <String>[],
      'rating': 0,
      'showAll': false,
    },
    {
      ...
      'author': 'NAMDER KUMAR',
      'image': 'assets/physicsbook2.jpeg',
      'route': '/physicsbook2',
      'comments': <String>[],
      'rating': 0,
      'showAll': false,
    },
    {
      ...
      'author': 'B.K. PANDEY',
      'image': 'assets/physicsbook3.jpeg',
      'route': '/physicsbook3',
      'comments': <String>[],
      'rating': 0,
      'showAll': false,
    },
    {
      ...
      'author': 'S. PANIGRAHI',
      'image': 'assets/physicsbook4.jpeg',
      'route': '/physicsbook4',
      'comments': <String>[],
      'rating': 0,
      'showAll': false,
    },
    {
      'title': 'ENGINEERING PHYSICS',
      'author': 'S. MANI NAIDU',
      'image': 'assets/physicsbook5.jpeg',
      'route': '/physicsbook5',
      'comments': <String>[],
      'rating': 0,
      'showAll': false,
