...
class PythonBookscreen5 extends StatefulWidget {
  @override
  _PythonBookscreen5State createState() => _PythonBookscreen5State();
}

class _PythonBookscreen5State extends State<PythonBookscreen5> {
  int _rating = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("PYTHON DATA SCIENCE HANDBOOK"),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              const Text(
                "A practical guide to data science with Python.\n"
                "Covers NumPy, Pandas, Matplotlib, Scikit-learn, and more.\n"
                "Ideal for machine learning and data analysis.\n"
                "Hands-on coding examples provided.\n"
                "Essential for data-driven Python projects.",
