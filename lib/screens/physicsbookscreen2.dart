...
class PhysicsBookscreen2 extends StatefulWidget {
  @override
  _PhysicsBookscreen2State createState() => _PhysicsBookscreen2State();
}

class _PhysicsBookscreen2State extends State<PhysicsBookscreen2> {
  int _rating = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("ENGINEERING PHYSICS - 2"),
            ...
            children: [
              Center(
                child: ClipRRect(
                  ...
                  child: Image.asset(
                    'assets/physicsbook2.jpeg', // Replace with actual image
                    height: 220,
                    fit: BoxFit.cover,
                  ),
                ),
              ...
              const SizedBox(height: 8),
              const Text(
                "Volume 2 of Engineering Physics covers wave optics, lasers, and nanotechnology with practical examples.",
