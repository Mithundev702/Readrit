...
class CProgrammingBookScreen3 extends StatefulWidget {
  @override
  _CProgrammingBookScreen3State createState() => _CProgrammingBookScreen3State();
}

class _CProgrammingBookScreen3State extends State<CProgrammingBookScreen3> {
  int _rating = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("C PROGRAMMING - 3"),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              const Text(
                "Detailed explanation of C programming concepts and problem solving using ANSI standard C.",
