...
class CProgrammingBookScreen2 extends StatefulWidget {
  @override
  _CProgrammingBookScreen2State createState() => _CProgrammingBookScreen2State();
}

class _CProgrammingBookScreen2State extends State<CProgrammingBookScreen2> {
  int _rating = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("C PROGRAMMING - 2"),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              const Text(
                "Step-by-step guide for beginners to learn C programming fundamentals with simple language and examples.",
