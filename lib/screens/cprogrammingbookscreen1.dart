...
class CProgrammingBookScreen1 extends StatefulWidget {
  @override
  _CProgrammingBookScreen1State createState() => _CProgrammingBookScreen1State();
}

class _CProgrammingBookScreen1State extends State<CProgrammingBookScreen1> {
  int _rating = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("C PROGRAMMING - 1"),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              const Text(
                "Comprehensive introduction to C programming concepts for beginners with easy examples and exercises.",
