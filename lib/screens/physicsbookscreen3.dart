...
class PhysicsBookscreen3 extends StatefulWidget {
  @override
  _PhysicsBookscreen3State createState() => _PhysicsBookscreen3State();
}

class _PhysicsBookscreen3State extends State<PhysicsBookscreen3> {
  int _rating = 0;
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              const Text(
                "Comprehensive guide to classical and modern physics tailored for undergraduate engineering students.",
