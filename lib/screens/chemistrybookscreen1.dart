...
class ChemistryBookScreen1 extends StatefulWidget {
  @override
  _ChemistryBookScreen1State createState() => _ChemistryBookScreen1State();
}

class _ChemistryBookScreen1State extends State<ChemistryBookScreen1> {
  int _rating = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("ENGINEERING CHEMISTRY - 1"),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              const Text(
                "Introduction to chemical bonding, structure, and basic engineering applications in real-world chemistry.",
